...
async function fetchPlanets() {
  ...
  const planetDetails = [
    ...
    { id: "planet-rotation", prop: "rotation", suffix: " DYGN I ANTAL JORDDYGN RUNT EGEN AXEL" },
    { id: "planet-circumference", prop: "circumference", suffix: " OMKRETS I KM " },
    { id: "planet-temp", prop: "temp", suffix: ` DAGSTEMPERATUR: ${tempDay}°C, NATTEMPERATUR: ${tempNight}°C` },
    { id: "planet-distance", prop: "distance", suffix: " KM FRÅN SOLEN " },
    { id: "planet-orbitalPeriod", prop: "orbitalPeriod", suffix: " ANTAL JORDDYGN RUNT SOLEN " },
  ...
  if (prop === "temp") {
    ...
    planetElement.innerHTML = findPlanet ? `${findPlanet[prop]}${suffix}` : "";
  }
  });
} catch (error) {
